#' Purchase Multi-City Tickets (3 Cities)
#'
...
#'
#' @usage Three_Cities(data, SRC, DST, date, PAX, SRC2, DST2, date2, PAX2, SRC3, DST3, dateReturn, PAX3)
#'
...
#' @export
#'
#' @examples Three_Cities("Flightist.csv", "Banglore", "New Delhi", "03/21/2019", 7, "Mumbai", "Hyderabad", "04/03/2019", 3, "Kolkata", "Banglore", "05/18/2019", 5)
