#' Purchase Multi-City Tickets (7 Cities) on a Preferred Airline
#'
...
#'
#' @usage Seven_Cities_with_Preferred_Airline(data, SRC, DST, date, PAX, airline, SRC2, DST2, date2, PAX2, airline2, SRC3, DST3, date3, PAX3, airline3, SRC4, DST4, date4, PAX4, airline4, SRC5, DST5, date5, PAX5, airline5, SRC6, DST6, date6, PAX6, airline6, SRC7, DST7, dateReturn, PAX7, airline7)
#'
...
#' @param airline7 Preferred airline
#'
#' @return Identify the data type in a console and view data in a spreadsheet-style data viewer.
#'
#' @export
#'
#' @examples Seven_Cities_with_Preferred_Airline("Flightist.csv", "Banglore", "New Delhi", "03/01/2019", 3, "IndiGo", "Delhi", "Cochin", "03/03/2019", 3, "Vistara", "Mumbai", "Hyderabad", "03/06/2019", 1, "Trujet", "Kolkata", "Banglore", "03/24/2019", 3, "Jet Airways", "Delhi", "Cochin", "04/01/2019", 3, "IndiGo", "Chennai", "Kolkata", "05/01/2019", 3, "Air India", "Kolkata", "Banglore", "05/06/2019", 2, "Vistara")

Seven_Cities_with_Preferred_Airline <- function(data, SRC, DST, date, PAX, airline,
                                                ...
                                                SRC7, DST7, dateReturn, PAX7, airline7) {
  data <- read.csv(data)
  ...
  data8 <- data[which(data$Source == SRC7 & data$Destination == DST7 & data$Date_of_Journey == dateReturn & data$Airline == airline7),]
