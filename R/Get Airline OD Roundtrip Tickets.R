#' Book Round-Trip Tickets with a Preferred Airline
#'
#' Input the inputs and output a dataframe that shows the departure and arrival schedules that match the given inputs.
#'
#' @usage Roundtrip_Airline_Preferred(data, SRC, DST, date, PAX, airline, SRC2, DST2, dateReturn, PAX2, airline2)
#'
...
#' @export
#'
#' @examples Roundtrip_Airline_Preferred("Flightist.csv", "Banglore", "New Delhi", "03/01/2019", 2, "Jet Airways Business", "Kolkata", "Banglore", "03/24/2019", 3, "GoAir")
#' @examples Roundtrip_Airline_Preferred("Flightist.csv", "Banglore", "New Delhi", "03/01/2019", 2, "Jet Airways Business", "Delhi", "Cochin", "03/21/2019", 2, "Multiple carriers Premium economy")
