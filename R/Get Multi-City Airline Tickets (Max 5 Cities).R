#' Purchase Multi-City Tickets (5 Cities) on a Preferred Airline
#'
...
#'
#' @usage Five_Cities_with_Preferred_Airline(data, SRC, DST, date, PAX, airline, SRC2, DST2, date2, PAX2, airline2, SRC3, DST3, date3, PAX3, airline3, SRC4, DST4, date4, PAX4, airline4, SRC5, DST5, dateReturn, PAX5, airline5)
#'
...
#' @export
#'
#' @examples Five_Cities_with_Preferred_Airline("Flightist.csv", "Chennai", "Kolkata", "03/01/2019", 3, "Vistara Premium economy", "Banglore", "New Delhi", "03/21/2019", 3, "Air India", "Delhi", "Cochin", "03/24/2019", 3, "Air India", "Mumbai", "Hyderabad", "05/01/2019", 3, "Jet Airways", "Kolkata", "Banglore", "05/18/2019", 4, "Vistara")

Five_Cities_with_Preferred_Airline <- function(data, SRC, DST, date, PAX, airline,
                                               SRC2, DST2, date2, PAX2, airline2,
                                               SRC3, DST3, date3, PAX3, airline3,
                                               SRC4, DST4, date4, PAX4, airline4,
                                               SRC5, DST5, dateReturn, PAX5, airline5) {
  data <- read.csv(data)
  ...
  data6 <- data[which(data$Source == SRC5 & data$Destination == DST5 & data$Date_of_Journey == dateReturn & data$Airline == airline5),]
