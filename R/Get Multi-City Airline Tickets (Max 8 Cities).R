#' Purchase Multi-City Tickets (8 Cities) on a Preferred Airline
#'
...
#'
#' @usage Eight_Cities_with_Preferred_Airline(data, SRC, DST, date, PAX, airline, SRC2, DST2, date2, PAX2, airline2, SRC3, DST3, date3, PAX3, airline3, SRC4, DST4, date4, PAX4, airline4, SRC5, DST5, date5, PAX5, airline5, SRC6, DST6, date6, PAX6, airline6, SRC7, DST7, date7, PAX7, airline7, SRC8, DST8, dateReturn, PAX8, airline8)
#'
