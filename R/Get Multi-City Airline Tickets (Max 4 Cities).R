#' Purchase Multi-City Tickets (4 Cities) on a Preferred Airline
#'
...
#'
#' @usage Four_Cities_with_Preferred_Airline(data, SRC, DST, date, PAX, airline, SRC2, DST2, date2, PAX2, airline2, SRC3, DST3, date3, PAX3, airline3, SRC4, DST4, dateReturn, PAX4, airline4)
#'
...
#' @export
#'
#' @examples Four_Cities_with_Preferred_Airline("Flightist.csv", "Banglore", "New Delhi", "03/21/2019", 10, "Air India", "Delhi", "Cochin", "03/27/2019", 10, "Air India", "Mumbai", "Hyderabad", "05/01/2019", 10, "Air India", "Kolkata", "Banglore", "05/18/2019", 10, "Air India")
