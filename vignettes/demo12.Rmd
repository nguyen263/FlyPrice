---
title: "How to Use the Six_Cities_with_Preferred_Airline Function"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{How to Use the Six_Cities_with_Preferred_Airline Function}
...
Six_Cities_with_Preferred_Airline returns both the data type and itinerary of the six cities with the most affordable prices (in accordance with the inputs provided) and computes the total cost of all those cities. Here's how it works:
