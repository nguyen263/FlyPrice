---
title: "How to Use the Three_Cities_with_Preferred_Airline Function"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{How to Use the Three_Cities_with_Preferred_Airline Function}
...
Three_Cities_with_Preferred_Airline returns both the data type and itinerary of the three cities with the most affordable prices (in accordance with the inputs provided) and computes the total cost of all three cities. Here's how it works:
...
Three_Cities_with_Preferred_Airline("Flightist.csv", "Banglore", "New Delhi", "03/21/2019", 7, "IndiGo", "Mumbai", "Hyderabad", "04/03/2019", 3, "IndiGo", "Kolkata", "Banglore", "05/18/2019", 5, "IndiGo")
```
