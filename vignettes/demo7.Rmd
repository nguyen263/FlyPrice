---
title: "How to Use the Four_Cities Function"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{How to Use the Four_Cities Function}
...
Four_Cities returns both the data type and itinerary of the four cities with the most affordable prices (in accordance with the inputs provided) and computes the total cost of all four cities. Here's how it works:
...
Four_Cities("Flightist.csv", "Banglore", "New Delhi", "03/21/2019", 10, "Delhi", "Cochin", "03/27/2019", 10, "Mumbai", "Hyderabad", "05/01/2019", 10, "Kolkata", "Banglore", "05/18/2019", 10)
```
