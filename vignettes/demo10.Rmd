---
title: "How to Use the Five_Cities_with_Preferred_Airline Function"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{How to Use the Five_Cities_with_Preferred_Airline Function}
...
Five_Cities_with_Preferred_Airline returns both the data type and itinerary of the five cities with the most affordable prices (in accordance with the inputs provided) and computes the total cost of all those cities. Here's how it works:
...
Five_Cities_with_Preferred_Airline("Flightist.csv", "Chennai", "Kolkata", "03/01/2019", 3, "Vistara Premium economy", "Banglore", "New Delhi", "03/21/2019", 3, "Air India", "Delhi", "Cochin", "03/24/2019", 3, "Air India", "Mumbai", "Hyderabad", "05/01/2019", 3, "Jet Airways", "Kolkata", "Banglore", "05/18/2019", 4, "Vistara")
```
