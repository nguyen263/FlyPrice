...
<p> The R package provides functions for generating flight data for price calculations. These functions require specific fields, including travel details: departure, arrival, dates, number of passengers, airline, and airline preference; a dataset is also needed.
